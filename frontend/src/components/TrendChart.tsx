...
export default function TrendChart({ data, category, statusLabel }: TrendChartProps) {
  ...
  return (
    <motion.div 
      ...
      viewport={{ once: true }}
      className="w-full h-[500px] p-10 rounded-[3rem] bg-[#0A0A0A]/40 backdrop-blur-3xl border border-white/5 overflow-hidden shadow-[0_40px_80px_rgba(0,0,0,0.6)] relative"
    >
